...
pygame.display.set_caption("NORAH- Pool Game")
...
cue_image = pygame.image.load('game (3)/game/assets/images/cue.png').convert_alpha()
t_image = pygame.image.load('game (3)/game/assets/images/table.png').convert_alpha()
balls_imgs = []
for imo in range(1,17):
    ball_img = pygame.image.load(f'game (3)/game/assets/images/ball_{imo}.png').convert_alpha()
